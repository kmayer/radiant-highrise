...
module Highrise
  ...
  class Person < Subject
    ...
    def phone
      contact_data.phone_numbers.first.number.strip rescue ''
    end
  end
...
module HighriseTags
  ...
  desc %{
    Prints the formatted name of the person
  }
  tag 'highrise:each:name' do |tag|
    tag.locals.person.name
  end
  
  tag 'highrise:each:phone' do |tag|
    tag.locals.person.phone
  end
